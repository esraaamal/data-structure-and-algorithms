...
let indx1 =arr[i].house;
// Object.values(indx1).forEach (val => {
//     houses.push(val) ;
//   });
...
const hasChildrenValues = (arr, character) => {
  ...
  // Solution code here...
  for(let i=0 ;i<arr.length;i++){
    let indx1 =arr[i].children;
    let index2=arr[i].name;
    if(index2 === character){
    if(indx1 !=null){
        return true ;
    }else{
...
Write a function named hasChildrenEntries that is similar 
to your hasChildrenValues function from challenge 3,
 but uses the data's entries instead of its values.

The input and output of this function are the same as the 
input and output from challenge 3.
------------------------------------------------------------------------------------------------ */
...
Write a function named totalCharacters that takes in an array 
and returns the number of characters in the array.
------------------------------------------------------------------------------------------------ */
...
const totalCharacters = (arr) => {
    ...
    for(let i=0 ;i<=arr.length;i++){
let leng =arr[i];
Object.values(leng).forEach (val => {
    total.push(val) ;    });
}

...
const standardizePhoneNumbers = (arr) => {
 ...
 let newArr =arr.forEach(val =>{
    ...
    let result = val.substring(1,4);
    let result2= val.substring(6,9);
    let result3=val.substring(10,14);
    
    arraySt.push(result+result2+result3);
 })
    return arraySt;
  // Solution code here...
};
...
//     let str1 =str.split('');
//   let newStr= str1.forEach((val,idx) =>{
      
//        if (val.charCodeAt()%2 !==0){
//            return val;
//        }else{
//            return 0;
//        }
...
let str2="";
while(i<str.length){
  let str4= str.charCodeAt(i);
    if (str4%2 ==0 && isNaN(str[i])){
        str2=str2+str[i];
        
    }else if (str4%2 !== 0 && !isNaN(str[i])){
      str2=str2+str[i];
    }
